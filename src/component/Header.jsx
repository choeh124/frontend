        ...
        <header>
            <nav>
                ...
                <div className='buttonBox'>
                    <button>채팅</button>
                    <button>로그아웃</button>
                    <button className='blue' >My Page<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
